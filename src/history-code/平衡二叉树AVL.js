...
class AVL {
    ...
    checkBalance(node) {
        ...
        if (this.getMaxHeight(node.left) - this.getMaxHeight(node.right) > 1) {
            if (this.getMaxHeight(node.left.left) >= this.getMaxHeight(node.left.right)) {
        ...
        } else if (this.getMaxHeight(node.right) - this.getMaxHeight(node.left) > 1) {
            if (this.getMaxHeight(node.right.right) >= this.getMaxHeight(node.right.left)) {
