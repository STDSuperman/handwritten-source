...
let rawData = [{
    ...
    "children": [{
        ...
        "children": [{
            "type": "text",
            "content": "20号正文字体 20号正文字体  20号正文字体  20号正文字体  20号正文字体",
            "attrs": {}
        }],
        "attrs": {}
    }, {
        ...
        "children": [{
            ...
            "children": [{
                "type": "text",
                "content": "17号正文字体 17号正文字体  17号正文字体",
                "attrs": {}
            }],
            "attrs": {
        ...
        "children": [{
            ...
            "children": [{
                "type": "text",
                "content": "15号正文字体 15号正文字体  15号正文字体  15号正文字体",
                "attrs": {}
            }],
            "attrs": {
        ...
        "children": [{
            ...
            "children": [{
                "type": "text",
                "content": "10号正文字体 10号正文字体  10号正文字体  10号正文字体",
                "attrs": {}
            }],
            "attrs": {
...
function changeFontSize(arr) {
    ...
    for (let i = 0; i < arrLen; i++) {
        ...
        if (item.attrs && item.attrs.style && reg.test(item.attrs.style.trim())) {
            item.attrs.style = item.attrs.style.replace(reg, `font-size:${RegExp.$1-4}px`)
        }
    }
    return arr;
}
